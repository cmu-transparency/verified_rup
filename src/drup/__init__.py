...
checker.check.argtypes = [ctypes.POINTER(Cnf_struct), ctypes.POINTER(Cnf_struct)]
checker.check.restype = ctypes.POINTER(Result_struct)
checker.check_derivation.argtypes = [ctypes.POINTER(Cnf_struct), ctypes.POINTER(Cnf_struct)]
checker.check_derivation.restype = ctypes.POINTER(Result_struct)
checker.check_fast.argtypes = [ctypes.POINTER(Cnf_struct), ctypes.POINTER(Cnf_struct)]
checker.check_fast.restype = ctypes.POINTER(Result_struct)
checker.check_derivation_fast.argtypes = [ctypes.POINTER(Cnf_struct), ctypes.POINTER(Cnf_struct)]
checker.check_derivation_fast.restype = ctypes.POINTER(Result_struct)
